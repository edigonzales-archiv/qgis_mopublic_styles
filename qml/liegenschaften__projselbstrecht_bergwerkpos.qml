...
<qgis version="2.3.0-Master" minimumScale="-4.65661e-10" maximumScale="6000" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" name="selbstrecht_bergwerkpos_von"/>
    ...
    <edittype labelontop="0" editable="1" name="hali"/>
    <edittype labelontop="0" editable="1" name="vali"/>
    <edittype labelontop="0" editable="1" name="bfsnr"/>
    <edittype labelontop="0" editable="1" name="y"/>
    <edittype labelontop="0" editable="1" name="x"/>
    <edittype labelontop="0" editable="1" name="rot"/>
    <edittype labelontop="0" editable="1" name="hali_txt"/>
    <edittype labelontop="0" editable="1" name="vali_txt"/>
  </edittypes>
  <editform>.</editform>
