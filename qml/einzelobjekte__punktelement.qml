...
<qgis version="2.3.0-Master" minimumScale="0" maximumScale="6000" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule filter="&quot;art&quot; =  'Bildstock_Kruzifix' " symbol="0" label="Bildstock, Kruzifix"/>
      <rule filter="&quot;art&quot; = 'Denkmal'" symbol="1" label="Denkmal"/>
      <rule filter="&quot;art&quot; = 'einzelner_Fels'" symbol="2" label="einzelner Fels"/>
      <rule filter="&quot;art&quot; = 'Grotte_Hoehleneingang'" symbol="3" label="Grotte, Höhleneingang"/>
      <rule filter="&quot;art&quot; = 'Mast_Antenne'" symbol="4" label="Mast, Antenne"/>
      <rule filter="&quot;art&quot; = 'Quelle'" symbol="5" label="Quelle"/>
      <rule filter="&quot;art&quot; = 'wichtiger_Einzelbaum'" symbol="6" label="wichtiger Einzelbaum"/>
    </rules>
    <symbols>
      <symbol alpha="1" type="marker" name="0">
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="size" v="4"/>
          <prop k="size_expression" v="CASE WHEN $scale &lt; 750 THEN 125 WHEN $scale >= 750 AND $scale &lt; 1250 THEN 64 WHEN $scale >= 1250 AND $scale &lt; 3000 THEN 32 WHEN $scale >= 3000 THEN 16 END"/>
