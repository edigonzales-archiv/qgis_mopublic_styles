    ...
    <symbols>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="PointPatternFill" locked="0">
          ...
          <prop k="displacement_x_expression" v="CASE WHEN $scale &lt; 750 THEN 1.05 WHEN $scale >= 750 AND $scale &lt; 1250 THEN 0.75 WHEN $scale >= 1250 AND $scale &lt; 3000 THEN 0.5 WHEN $scale >= 3000 THEN 0.35 END"/>
          ...
          <prop k="distance_x_expression" v="CASE WHEN $scale &lt; 750 THEN 2.1 WHEN $scale >= 750 AND $scale &lt; 1250 THEN 1.5 WHEN $scale >= 1250 AND $scale &lt; 3000 THEN 1 WHEN $scale >= 3000 THEN 0.7 END"/>
          <prop k="distance_x_map_unit_scale" v="0,0"/>
          <prop k="distance_x_unit" v="MM"/>
          <prop k="distance_y" v="15"/>
          <prop k="distance_y_expression" v="CASE WHEN $scale &lt; 750 THEN 2.1 WHEN $scale >= 750 AND $scale &lt; 1250 THEN 1.5 WHEN $scale >= 1250 AND $scale &lt; 3000 THEN 1 WHEN $scale >= 3000 THEN 0.7 END"/>
          ...
          <symbol alpha="1" type="marker" name="@0@0">
            <layer pass="0" class="SimpleMarker" locked="0">
              ...
              <prop k="size" v="2"/>
              <prop k="size_expression" v="CASE WHEN $scale &lt; 750 THEN 0.49 WHEN $scale >= 750 AND $scale &lt; 1250 THEN 0.25 WHEN $scale >= 1250 AND $scale &lt; 3000 THEN 0.1225 WHEN $scale >= 3000 THEN 0.0625 END"/>
