    ...
    <symbols>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="customdash_expression" v="CASE WHEN $scale &lt; 750 THEN '3.5;1.0' WHEN $scale >= 750 AND $scale &lt; 1250 THEN '2.5;0.7' WHEN $scale >= 1250 AND $scale &lt; 3000 THEN '1.75;0.5' WHEN $scale >= 3000 THEN '1.2;0.34' END"/>
