...
<qgis version="2.3.0-Master" minimumScale="-4.65661e-10" maximumScale="6000" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      ...
      <rule filter="&quot;art&quot; IN ('Gebaeude', 'Gewaesser_fliessendes', 'Flugplatz', 'Gewaesser_stehendes', 'Strasse_Weg', 'Trottoir', 'Verkehrsinsel', 'Wasserbecken')" symbol="1" label="ausgezogen"/>
      <rule filter="&quot;art&quot; IN ('Abbau_Deponie', 'Acker_Wiese_Weide', 'Bahn', 'Fels', 'Gartenanlage', 'Geroell_Sand', 'geschlossener_Wald', 'Gletscher_Firn', 'Hoch_Flachmoor', 'Reben', 'Schilfguertel', 'uebrige_befestigte', 'uebrige_bestockte', 'uebrige_Intensivkultur', 'uebrige_vegetationslose', 'Wytweide_dicht', 'Wytweide_offen')" symbol="2" label="gestrichelt"/>
      <rule filter="&quot;art&quot;  =  'geschlossener_Wald' " symbol="3" label="geschlossener Wald"/>
      <rule filter="&quot;art&quot;  =  'uebrige_bestockte' " symbol="4" label="übrige bestockte"/>
      <rule filter="&quot;art&quot;  =  'Hoch_Flachmoor' " symbol="5" label="Moor"/>
      <rule filter="&quot;art&quot; = 'Reben'" symbol="6" label="Reben"/>
      <rule filter="&quot;art&quot; = 'Schilfguertel'" symbol="7" label="Schilfgürtel"/>
      <rule filter="&quot;art&quot; = 'Fels'" symbol="8" label="Fels"/>
      <rule filter="&quot;art&quot; = 'Geroell_Sand'" symbol="9" label="Geröll / Sand"/>
      <rule filter="&quot;art&quot; IN ('Wasserbecken', 'Gewaesser_stehendes')" symbol="10" label="Wasserbecken / stehendes Gewässer"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" type="fill" name="3">
        <layer pass="0" class="PointPatternFill" locked="0">
          ...
          <prop k="displacement_x_expression" v="CASE WHEN $scale &lt; 750 THEN 1.4 WHEN $scale >= 750 AND $scale &lt; 1250 THEN 1 WHEN $scale >= 1250 AND $scale &lt; 3000 THEN 0.7 WHEN $scale >= 3000 THEN 0.5 END"/>
          ...
          <prop k="distance_x_expression" v="CASE WHEN $scale &lt; 750 THEN 2.8 WHEN $scale >= 750 AND $scale &lt; 1250 THEN 2 WHEN $scale >= 1250 AND $scale &lt; 3000 THEN 1.4 WHEN $scale >= 3000 THEN 1 END"/>
          <prop k="distance_x_map_unit_scale" v="0,0"/>
          <prop k="distance_x_unit" v="MM"/>
          <prop k="distance_y" v="15"/>
          <prop k="distance_y_expression" v="CASE WHEN $scale &lt; 750 THEN 2.8 WHEN $scale >= 750 AND $scale &lt; 1250 THEN 2 WHEN $scale >= 1250 AND $scale &lt; 3000 THEN 1.4 WHEN $scale >= 3000 THEN 1 END"/>
